#!/usr/bin/env python3
"""
Evaluate K-Fold Test Sets Detailed Results
...
Usage:
    python evaluate_kfold_testsets.py --config configs/bounded.yaml \
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate specific test sets for K-Fold CV')
    ...
    parser.add_argument('--output_dir', type=str, default='test_results', help='详细结果表格保存路径')
